...
# To add entries to PATH (on Windows you might use Path), you can use the following pattern:
# $env.PATH = ($env.PATH | split row (char esep) | prepend '/some/path')
$env.SPARK_HOME = "/opt/apache-spark/current"

$env.PATH = ($env.PATH | prepend "/usr/local/bin")
$env.PATH = ($env.PATH | prepend "/usr/libexec")
$env.PATH = ($env.PATH | prepend "/Applications/WezTerm.app/Contents/MacOS/")
$env.PATH = ($env.PATH | prepend $"($env.SPARK_HOME)/bin")
...
$env.MAVEN_OPTS = "-Dspring.profiles.active=local "

#mkdir ~/.cache/starship
#starship init nu | save -f ~/.cache/starship/init.nu
#$env.AWS_PROFILE = "DISQO_Sandbox_Lift_Non-Prod"

$env.DOCKER_OPTS = " --insecure-registry data-platform-docker-repo.localhost"
source /Users/jack.wright/src/ayax79/config/nu/extra-env.nu
